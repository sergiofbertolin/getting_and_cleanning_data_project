...
Standard Deviation of Body Acceleration measurements on frequency domain and corresponding axis X,Y, or Z (in g) 

[46] "FreqBodyAccelerationStdX"             
[47] "FreqBodyAccelerationStdY"             
[48] "FreqBodyAccelerationStdZ"             

Mean of Body Acceleration measurements on frequency domain and corresponding axis X,Y, or Z, derived in time (in g)

[49] "FreqBodyAccelerationJerkMeanX"        
[50] "FreqBodyAccelerationJerkMeanY"        
[51] "FreqBodyAccelerationJerkMeanZ"        

Standard Deviation of Body Acceleration measurements on frequency domain and corresponding axis X,Y, or Z, derived in time (in g)

[52] "FreqBodyAccelerationJerkStdX"         
[53] "FreqBodyAccelerationJerkStdY"         
[54] "FreqBodyAccelerationJerkStdZ"         

Mean of Body Angular Velocity measurements on frequency domain and corresponding axis X,Y, or Z (in g)

[55] "FreqBodyGyroscopeMeanX"               
[56] "FreqBodyGyroscopeMeanY"               
[57] "FreqBodyGyroscopeMeanZ"               

Standard deviation of Body Angular Velocity measurements on frequency domain and corresponding axis X,Y, or Z (in g)

[58] "FreqBodyGyroscopeStdX"                
[59] "FreqBodyGyroscopeStdY"                
[60] "FreqBodyGyroscopeStdZ"                

Magnitude of three-dimensional signals (axis X,Y and Z) using the Euclidean norm of X,Y and Z axis measurements of Mean of Body Acceleration measurements on frequency domain (in g)

[61] "FreqBodyAccelerationMagnitudeMean"    

Magnitude of three-dimensional signals (axis X,Y and Z) using the Euclidean norm of X,Y and Z axis measurements of Standard Deviation of Body Acceleration measurements on frequency domain (in g)

[62] "FreqBodyAccelerationMagnitudeStd"     

Magnitude of three-dimensional signals (axis X,Y and Z) using the Euclidean norm of X,Y and Z axis measurements of Mean of Body Acceleration measurements on frequency domain, derived in time (in g)

[63] "FreqBodyAccelerationJerkMagnitudeMean"

Magnitude of three-dimensional signals (axis X,Y and Z) using the Euclidean norm of X,Y and Z axis measurements of Standard Deviation of Body Acceleration measurements on frequency domain, derived in time (in g)

[64] "FreqBodyAccelerationJerkMagnitudeStd" 

Magnitude of three-dimensional signals (axis X,Y and Z) using the Euclidean norm of X,Y and Z axis measurements of Mean of Angular Velocity measurements on frequency domain (in g)

[65] "FreqBodyGyroscopeMagnitudeMean"       

Magnitude of three-dimensional signals (axis X,Y and Z) using the Euclidean norm of X,Y and Z axis measurements of Standard Deviation of Angular Velocity measurements on frequency domain (in g)

[66] "FreqBodyGyroscopeMagnitudeStd"        

Magnitude of three-dimensional signals (axis X,Y and Z) using the Euclidean norm of X,Y and Z axis measurements of Mean of Angular Velocity measurements on frequency domain, derived in time (in g)
